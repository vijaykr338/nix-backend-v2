...
router.route("/update/:filename").put(protect, protect_update, storage.single("image"), update_image);
router.route("/upload").post(protect, protect_upload, storage.single("image"), upload_image);
