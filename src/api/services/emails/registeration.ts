    ...
    this.html = `<html>
        ...
        <body>
            ...
            <div class="container" style="padding:1rem 0 2rem 0;">
                <h1 class="heading-1" style="text-align:center;"> <small>Welcome</small> <small>To DTU Times.</small> </h1>
                <div>
                    ...
                    <div class="text" style="margin-bottom:20px; text-align:center;">
                        <p>
                            <h5>Hey ${name}, Welcome to DTU Times.</h5><br> Happy to have you on board! <br> You can login with <strong>${password}</strong> as your password. </p>
                    </div>
                </div><br><br> <a href="${APP_URL}" class="btn">Login</a> </div><br><br>
...
export default RegisterationMail;